...
### 🛡️ Cyber Security | SOC | VAPT | Red Team | Blue Team
...
🎓 Cyber Security Engineering Student | Ahmedabad Institute of Technology (GTU)
...
## 🧰 Skills & Security Interests

<p>
  <img src="https://skillicons.dev/icons?i=python,c,bash,linux,git" alt="Python C Bash Linux Git"/>
</p>

**Security Domains**

🔵 Blue Team • 🔴 Red Team • 🖥️ SOC • ⚔️ VAPT • 🕵️ Digital Forensics

**Tools & Technologies**

`Nmap` `Wireshark` `Burp Suite` `Autopsy` `Scapy` `Flask` `iptables`

**Security Concepts**

`OWASP Top 10` `Network Security` `Threat Analysis` `Security Monitoring` `Packet Analysis`

---

## 🎓 Certifications

🏅 **CIOSE** — Certified Information and Offensive Security Expert

🛡️ **CCDP** — Certified Cyber Defence Professional
...
Secured a position in the **Top 10 teams among 40+ participating teams** at a Cyber Security CTF competition in Ahmedabad.

---

## 💼 Currently

🔐 Cyber Security Intern (SOC) at CyArt Tech LLP

🚀 Building and exploring practical cybersecurity projects.

🎯 Open to opportunities in SOC, Cyber Security Analysis, VAPT, and Digital Forensics.
...
### ⭐ Explore my repositories and follow my cybersecurity journey!
